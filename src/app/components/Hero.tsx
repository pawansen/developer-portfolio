      ...
      <div className='hidden md:block'>
        <div className='flex justify-between items-center pt-10 p-5'>
          <div className='w-100'>
            ...
            <p className='text-5xl font-bold primary-color mt-5'><span className='text-white'>I&lsquo;m </span>Pawan</p>
            <p className='text-5xl font-bold primary-color'>Sen</p>

            <p className='text-xl py-6'>A Full-Stack Developer</p>
